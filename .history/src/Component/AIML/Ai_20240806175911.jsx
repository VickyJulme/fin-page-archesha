            ...
            <div className="flex flex-col gap-10 px-4 py-10 @container ">
              ...
              <div Clas="grid grid-cols-[repeat(auto-fit,minmax(158px,1fr))] gap-3 p-0">
                <div Clas="flex flex-1 gap-3 rounded-lg border border-[#cedde8] bg-slate-50 p-4 flex-col">
                  <div Clas="text-[#0d151c]" data-icon="Brain" data-size="24px" data-weight="regular">
                  ...
                  <div Clas="flex flex-col gap-1">
                    <h2 Clas="text-[#0d151c] text-base font-bold leading-tight">Week 1: Understand AI/ML</h2>
                ...
                <div Clas="flex flex-1 gap-3 rounded-lg border border-[#cedde8] bg-slate-50 p-4 flex-col">
                  <div Clas="text-[#0d151c]" data-icon="Users" data-size="24px" data-weight="regular">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
                      <path
                  ...
                  <div Clas="flex flex-col gap-1">
                    <h2 Clas="text-[#0d151c] text-base font-bold leading-tight">Week 2: Deep Learning</h2>
                    <p Clas="text-[#49779c] text-sm font-normal leading-normal">
                ...
                <div Clas="flex flex-1 gap-3 rounded-lg border border-[#cedde8] bg-slate-50 p-4 flex-col">
                  <div Clas="text-[#0d151c]" data-icon="Chats" data-size="24px" data-weight="regular">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
                      <path
                  ...
                  <div Clas="flex flex-col gap-1">
                    <h2 Clas="text-[#0d151c] text-base font-bold leading-tight">Week 3: Tools and Techniques</h2>
                    <p Clas="text-[#49779c] text-sm font-normal leading-normal">
                ...
                <div Clas="flex flex-1 gap-3 rounded-lg border border-[#cedde8] bg-slate-50 p-4 flex-col">
                  <div Clas="text-[#0d151c]" data-icon="Gauge" data-size="24px" data-weight="regular">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
                      <path
                  ...
                  <div Clas="flex flex-col gap-1">
                    <h2 Clas="text-[#0d151c] text-base font-bold leading-tight">Week 4: Industry Applications</h2>
                    <p Clas="text-[#49779c] text-sm font-normal leading-normal">
