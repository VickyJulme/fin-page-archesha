    ...
    <div className='flex justify-center items-center'>
           ...
           <div className='con1  items-end flex  bg-red-500 mt-28  ) '>
                ...
                <div className="flex flex-col   gap-4  w-full mb-20 pl-20 ">
                    ...
                    <button
                    className="  w-20 h-15   cursor-pointer items-center justify-center overflow-hidden rounded-xl h-10 px-4 :h-12 :px-5 bg-[#2094f3] text-slate-50 text-sm font-bold leading-normal tracking-[0.015em] @[480px]:text-base @[480px]:font-bold @[480px]:leading-normal @[480px]:tracking-[0.015em]"
                  >
