            ...
            <div className="flex flex-col gap-10 px-4 py-10 @container ">
              ...
              <div Clas="grid grid-cols-[repeat(auto-fit,minmax(158px,1fr))] gap-3 p-0">
                <div Clas="flex flex-1 gap-3 rounded-lg border border-[#cedde8] bg-slate-50 p-4 flex-col">
                  <div Clas="text-[#0d151c]" data-icon="Code" data-size="24px" data-weight="regular">
                  ...
                  <div Clas="flex flex-col gap-1">
                    <h2 Clas="text-[#0d151c] text-base font-bold leading-tight">Week 1: HTML and CSS</h2>
                    <p Clas="text-[#49779c] text-sm font-normal leading-normal">Learn the fundamentals of HTML and CSS, including responsive design and best practices.</p>
                  </div>
                </div>
                <div Clas="flex flex-1 gap-3 rounded-lg border border-[#cedde8] bg-slate-50 p-4 flex-col">
                  <div Clas="text-[#0d151c]" data-icon="File" data-size="24px" data-weight="regular">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
                      <path
                  ...
                  <div Clas="flex flex-col gap-1">
                    <h2 Clas="text-[#0d151c] text-base font-bold leading-tight">Week 2: JavaScript</h2>
                ...
                <div Clas="flex flex-1 gap-3 rounded-lg border border-[#cedde8] bg-slate-50 p-4 flex-col">
                  <div Clas="text-[#0d151c]" data-icon="Atom" data-size="24px" data-weight="regular">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
                      <path
                  ...
                  <div Clas="flex flex-col gap-1">
                    <h2 Clas="text-[#0d151c] text-base font-bold leading-tight">Week 3: React</h2>
                    <p Clas="text-[#49779c] text-sm font-normal leading-normal">
                ...
                <div Clas="flex flex-1 gap-3 rounded-lg border border-[#cedde8] bg-slate-50 p-4 flex-col">
                  <div Clas="text-[#0d151c]" data-icon="Scales" data-size="24px" data-weight="regular">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
                      <path
                  ...
                  <div Clas="flex flex-col gap-1">
                    <h2 Clas="text-[#0d151c] text-base font-bold leading-tight">Week 4: Redux</h2>
                    <p Clas="text-[#49779c] text-sm font-normal leading-normal">
                ...
                <div Clas="flex flex-1 gap-3 rounded-lg border border-[#cedde8] bg-slate-50 p-4 flex-col">
                  <div Clas="text-[#0d151c]" data-icon="Lightbulb" data-size="24px" data-weight="regular">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
                      <path
                  ...
                  <div Clas="flex flex-col gap-1">
                    <h2 Clas="text-[#0d151c] text-base font-bold leading-tight">Week 5: Advanced Topics</h2>
                    <p Clas="text-[#49779c] text-sm font-normal leading-normal">
                ...
                <div Clas="flex flex-1 gap-3 rounded-lg border border-[#cedde8] bg-slate-50 p-4 flex-col">
                  <div Clas="text-[#0d151c]" data-icon="GraduationCap" data-size="24px" data-weight="regular">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
                      <path
                  ...
                  <div Clas="flex flex-col gap-1">
                    <h2 Clas="text-[#0d151c] text-base font-bold leading-tight">Week 6: Capstone Project</h2>
                    <p Clas="text-[#49779c] text-sm font-normal leading-normal">Review and optimize your project. Receive feedback from instructors and industry professionals.</p>
                  </div>
                </div>
              </div>
            </div>
