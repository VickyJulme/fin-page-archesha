...
function Hr() {
  return (
    <div className='flex justify-center items-center'>
      ...
      <div className='con1    bg-red-500 mt-28  ) '>

        <div className='con2 w-full h-full items-end flex rounded-xl'>
          <div className="flex flex-col   gap-4 bg-black w-full mb-20 pl-20 ">
            <h1
            ...
            <div className=' w-full'>
              ...
              <button
                className="  w-24 py-3 mt-5  cursor-pointer   rounded-xl px-4  bg-[#2094f3] text-slate-50 text-base font-bold leading-normal "
              >
