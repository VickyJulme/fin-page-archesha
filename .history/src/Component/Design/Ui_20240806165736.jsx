            ...
            <div className="grid grid-cols-[repeat(auto-fit,minmax(158px,1fr))] gap-3 p-0 ">
              <div className="flex flex-1 gap-3 rounded-lg border border-[#cedde8] bg-slate-50 p-4 flex-col  hover:shadow-lg hover:shadow-red-300">
                ...
                <div CLas="flex flex-col gap-1">
                    <h2 CLas="text-[#0d151c] text-base font-bold leading-tight">Week 1: Understand UI/UX</h2>
                ...
                <div CLas="flex flex-1 gap-3 rounded-lg border border-[#cedde8] bg-slate-50 p-4 flex-col">
                  ...
                  <div CLas="flex flex-col gap-1">
                    <h2 CLas="text-[#0d151c] text-base font-bold leading-tight">Week 2: Design Principles</h2>
                    <p CLas="text-[#49779c] text-sm font-normal leading-normal">
