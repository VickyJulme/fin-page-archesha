...
<div>
      <div className="grid grid-cols-[repeat(auto-fit,minmax(158px,1fr))] gap-3 p-0">
                <div className="flex flex-1 gap-3 rounded-lg border border-[#cedde8] bg-slate-50 p-4 flex-col">
                  <div className="text-[#0d151c]" data-icon="Storefront" data-size="24px" data-weight="regular">
                ...
                <div className="flex flex-1 gap-3 rounded-lg border border-[#cedde8] bg-slate-50 p-4 flex-col">
                  ...
                  <div className="flex flex-col gap-1">
                    <h2 className="text-[#0d151c] text-base font-bold leading-tight">Week 2: Digital Marketing</h2>
                    <p className="text-[#49779c] text-sm font-normal leading-normal">Learn how to use Digital Marketing tools and platforms effectively.</p>
                  </div>
                </div>
                <div className="flex flex-1 gap-3 rounded-lg border border-[#cedde8] bg-slate-50 p-4 flex-col">
                  ...
                  <div className="flex flex-col gap-1">
                    <h2 className="text-[#0d151c] text-base font-bold leading-tight">Week 3: Branding and Strategy</h2>
                    <p className="text-[#49779c] text-sm font-normal leading-normal">Dive into the world of Branding and Marketing Strategy.</p>
                  </div>
                </div>
                <div className="flex flex-1 gap-3 rounded-lg border border-[#cedde8] bg-slate-50 p-4 flex-col">
                  ...
                  <div className="flex flex-col gap-1">
                    <h2 className="text-[#0d151c] text-base font-bold leading-tight">Week 4: Marketing Analytics</h2>
                    <p className="text-[#49779c] text-sm font-normal leading-normal">Master the art of Marketing Analytics and Reporting.</p>
                  </div>
                </div>
              </div>
            </div>
