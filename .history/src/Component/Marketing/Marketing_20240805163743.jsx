...
<div>
      <div C="grid grid-cols-[repeat(auto-fit,minmax(158px,1fr))] gap-3 p-0">
                <div C="flex flex-1 gap-3 rounded-lg border border-[#cedde8] bg-slate-50 p-4 flex-col">
                  <div C="text-[#0d151c]" data-icon="Storefront" data-size="24px" data-weight="regular">
                  ...
                  <div C="flex flex-col gap-1">
                    <h2 C="text-[#0d151c] text-base font-bold leading-tight">Week 1: Introduction to Marketing</h2>
                    <p C="text-[#49779c] text-sm font-normal leading-normal">Understand the basics of Marketing and its applications in the industry.</p>
                  </div>
                </div>
                <div C="flex flex-1 gap-3 rounded-lg border border-[#cedde8] bg-slate-50 p-4 flex-col">
                  <div C="text-[#0d151c]" data-icon="Television" data-size="24px" data-weight="regular">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
                      <path
                  ...
                  <div C="flex flex-col gap-1">
                    <h2 C="text-[#0d151c] text-base font-bold leading-tight">Week 2: Digital Marketing</h2>
                    <p C="text-[#49779c] text-sm font-normal leading-normal">Learn how to use Digital Marketing tools and platforms effectively.</p>
                  </div>
                </div>
                <div C="flex flex-1 gap-3 rounded-lg border border-[#cedde8] bg-slate-50 p-4 flex-col">
                  <div C="text-[#0d151c]" data-icon="Brandy" data-size="24px" data-weight="regular">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
                      <path
                  ...
                  <div C="flex flex-col gap-1">
                    <h2 C="text-[#0d151c] text-base font-bold leading-tight">Week 3: Branding and Strategy</h2>
                    <p C="text-[#49779c] text-sm font-normal leading-normal">Dive into the world of Branding and Marketing Strategy.</p>
                  </div>
                </div>
                <div C="flex flex-1 gap-3 rounded-lg border border-[#cedde8] bg-slate-50 p-4 flex-col">
                  ...
                  <div C="flex flex-col gap-1">
                    <h2 C="text-[#0d151c] text-base font-bold leading-tight">Week 4: Marketing Analytics</h2>
                    <p C="text-[#49779c] text-sm font-normal leading-normal">Master the art of Marketing Analytics and Reporting.</p>
                  </div>
                </div>
              </div>
            </div>
