          ...
          <div className=" w-full">
            ...
            <div className="flex flex-col gap-10 px-4 py-10 @container ">
              <div className="flex flex-col gap-4">
                ...
                This is a 4-week program. Each week we'll cover a different aspect of Marketing. You'll learn <br/>
                by doing - we'll give you real-world projects to help you practicewhat you learn. Here's the<br/>
                 breakdown:
                </p>
              </div>
              </div>
...
<div class="grid grid-cols-[repeat(auto-fit,minmax(158px,1fr))] gap-3 p-0">
                <div class="flex flex-1 gap-3 rounded-lg border border-[#cedde8] bg-slate-50 p-4 flex-col">
                  ...
                  <div class="flex flex-col gap-1">
                    <h2 class="text-[#0d151c] text-base font-bold leading-tight">Week 1: Introduction to Marketing</h2>
                    <p class="text-[#49779c] text-sm font-normal leading-normal">Understand the basics of Marketing and its applications in the industry.</p>
                  </div>
                </div>
                <div class="flex flex-1 gap-3 rounded-lg border border-[#cedde8] bg-slate-50 p-4 flex-col">
                  <div class="text-[#0d151c]" data-icon="Television" data-size="24px" data-weight="regular">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
                      <path
                  ...
                  <div class="flex flex-col gap-1">
                    <h2 class="text-[#0d151c] text-base font-bold leading-tight">Week 2: Digital Marketing</h2>
                    <p class="text-[#49779c] text-sm font-normal leading-normal">Learn how to use Digital Marketing tools and platforms effectively.</p>
                  </div>
                </div>
                <div class="flex flex-1 gap-3 rounded-lg border border-[#cedde8] bg-slate-50 p-4 flex-col">
                  <div class="text-[#0d151c]" data-icon="Brandy" data-size="24px" data-weight="regular">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
                      <path
                  ...
                  <div class="flex flex-col gap-1">
                    <h2 class="text-[#0d151c] text-base font-bold leading-tight">Week 3: Branding and Strategy</h2>
                    <p class="text-[#49779c] text-sm font-normal leading-normal">Dive into the world of Branding and Marketing Strategy.</p>
                  </div>
                </div>
                <div class="flex flex-1 gap-3 rounded-lg border border-[#cedde8] bg-slate-50 p-4 flex-col">
                  ...
                  <div class="flex flex-col gap-1">
                    <h2 class="text-[#0d151c] text-base font-bold leading-tight">Week 4: Marketing Analytics</h2>
                    <p class="text-[#49779c] text-sm font-normal leading-normal">Master the art of Marketing Analytics and Reporting.</p>
                  </div>
                </div>
              </div>
            </div>
