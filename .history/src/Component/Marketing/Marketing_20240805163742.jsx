...
<div>
      <div ="grid grid-cols-[repeat(auto-fit,minmax(158px,1fr))] gap-3 p-0">
                <div ="flex flex-1 gap-3 rounded-lg border border-[#cedde8] bg-slate-50 p-4 flex-col">
                  <div ="text-[#0d151c]" data-icon="Storefront" data-size="24px" data-weight="regular">
                  ...
                  <div ="flex flex-col gap-1">
                    <h2 ="text-[#0d151c] text-base font-bold leading-tight">Week 1: Introduction to Marketing</h2>
                    <p ="text-[#49779c] text-sm font-normal leading-normal">Understand the basics of Marketing and its applications in the industry.</p>
                  </div>
                </div>
                <div ="flex flex-1 gap-3 rounded-lg border border-[#cedde8] bg-slate-50 p-4 flex-col">
                  <div ="text-[#0d151c]" data-icon="Television" data-size="24px" data-weight="regular">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
                      <path
                  ...
                  <div ="flex flex-col gap-1">
                    <h2 ="text-[#0d151c] text-base font-bold leading-tight">Week 2: Digital Marketing</h2>
                    <p ="text-[#49779c] text-sm font-normal leading-normal">Learn how to use Digital Marketing tools and platforms effectively.</p>
                  </div>
                </div>
                <div ="flex flex-1 gap-3 rounded-lg border border-[#cedde8] bg-slate-50 p-4 flex-col">
                  <div ="text-[#0d151c]" data-icon="Brandy" data-size="24px" data-weight="regular">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
                      <path
                  ...
                  <div ="flex flex-col gap-1">
                    <h2 ="text-[#0d151c] text-base font-bold leading-tight">Week 3: Branding and Strategy</h2>
                    <p ="text-[#49779c] text-sm font-normal leading-normal">Dive into the world of Branding and Marketing Strategy.</p>
                  </div>
                </div>
                <div ="flex flex-1 gap-3 rounded-lg border border-[#cedde8] bg-slate-50 p-4 flex-col">
                  <div ="text-[#0d151c]" data-icon="Presentation" data-size="24px" data-weight="regular">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
                      <path
                  ...
                  <div ="flex flex-col gap-1">
                    <h2 ="text-[#0d151c] text-base font-bold leading-tight">Week 4: Marketing Analytics</h2>
                    <p ="text-[#49779c] text-sm font-normal leading-normal">Master the art of Marketing Analytics and Reporting.</p>
                  </div>
                </div>
              </div>
            </div>
