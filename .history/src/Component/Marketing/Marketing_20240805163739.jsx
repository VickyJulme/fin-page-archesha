    ...
    <div>
      ...
      <div className="flex justify-center  flex-col items-center">
        <div className="container   w-full  mt-28  ) ">
          <div className="con22 ml-0 w-full h-full items-end flex rounded-xl">
            <div className="flex flex-col    gap-4  w-full mb-16 pl-20   max-sm:pl-3">
              ...
              <h2 className="text-white text-lg  font-normal ">
                Our live, online Marketing workshop helps you build the skills
            ...
            <div className="flex flex-col gap-10 px-4 py-10 @container ">
              <div className="flex flex-col gap-4">
                ...
                <p className="text-[#0d151c] text-base font-normal leading-normal max-w-[720px]">
                  ...
                  aspect of Marketing. You'll learn <br />
                  by doing - we'll give you real-world projects to help you
                  practicewhat you learn. Here's the
                  <br />
                  breakdown:
                </p>
              </div>
...
<div>
      <div lass="grid grid-cols-[repeat(auto-fit,minmax(158px,1fr))] gap-3 p-0">
                <div lass="flex flex-1 gap-3 rounded-lg border border-[#cedde8] bg-slate-50 p-4 flex-col">
                  <div lass="text-[#0d151c]" data-icon="Storefront" data-size="24px" data-weight="regular">
                  ...
                  <div lass="flex flex-col gap-1">
                    <h2 lass="text-[#0d151c] text-base font-bold leading-tight">Week 1: Introduction to Marketing</h2>
                    <p lass="text-[#49779c] text-sm font-normal leading-normal">Understand the basics of Marketing and its applications in the industry.</p>
                  </div>
                </div>
                <div lass="flex flex-1 gap-3 rounded-lg border border-[#cedde8] bg-slate-50 p-4 flex-col">
                  <div lass="text-[#0d151c]" data-icon="Television" data-size="24px" data-weight="regular">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
                      <path
                  ...
                  <div lass="flex flex-col gap-1">
                    <h2 lass="text-[#0d151c] text-base font-bold leading-tight">Week 2: Digital Marketing</h2>
                    <p lass="text-[#49779c] text-sm font-normal leading-normal">Learn how to use Digital Marketing tools and platforms effectively.</p>
                  </div>
                </div>
                <div lass="flex flex-1 gap-3 rounded-lg border border-[#cedde8] bg-slate-50 p-4 flex-col">
                  <div lass="text-[#0d151c]" data-icon="Brandy" data-size="24px" data-weight="regular">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
                      <path
                  ...
                  <div lass="flex flex-col gap-1">
                    <h2 lass="text-[#0d151c] text-base font-bold leading-tight">Week 3: Branding and Strategy</h2>
                    <p lass="text-[#49779c] text-sm font-normal leading-normal">Dive into the world of Branding and Marketing Strategy.</p>
                  </div>
                </div>
                <div lass="flex flex-1 gap-3 rounded-lg border border-[#cedde8] bg-slate-50 p-4 flex-col">
                  <div lass="text-[#0d151c]" data-icon="Presentation" data-size="24px" data-weight="regular">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
                      <path
                  ...
                  <div lass="flex flex-col gap-1">
                    <h2 lass="text-[#0d151c] text-base font-bold leading-tight">Week 4: Marketing Analytics</h2>
                    <p lass="text-[#49779c] text-sm font-normal leading-normal">Master the art of Marketing Analytics and Reporting.</p>
                  </div>
                </div>
              </div>
            </div>
