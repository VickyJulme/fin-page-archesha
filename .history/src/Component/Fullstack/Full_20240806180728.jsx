        ...
        <div className="cont203     mt-28  ) ">
          <div className="con2 w-full h-full items-end flex rounded-xl">
            <div className="flex flex-col    gap-4  w-full mb-16 pl-20   max-sm:pl-3">
              ...
              <h2 className="text-white text-  font-normal ">
          ...
          <div className=" w-full">
            ...
            <div className="flex flex-col gap-10 px-4 py-10 @container ">
              <div className="flex flex-col gap-4">
                ...
                This is an 8-week program. Each week we'll cover a different aspect of Full Stack Development. You'll learn by doing - we'll give you real-world projects to help
                  you practice what you learn. Here's the breakdown:
                </p>
              </div>
