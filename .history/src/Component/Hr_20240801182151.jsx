              ...
              <div class="grid grid-cols-[repeat(auto-fit,minmax(158px,1fr))] gap-3 p-0">
                <div class="flex flex-1 gap-3 rounded-lg border border-[#cedde8] bg-slate-50 p-4 flex-col">
                  ...
                  <div class="flex flex-col gap-1">
                    <h2 class="text-[#0d151c] text-base font-bold leading-tight">Week 1: Introduction to HR</h2>
                    <p class="text-[#49779c] text-sm font-normal leading-normal">Understand the basics of HR and its applications in the industry.</p>
                  </div>
                </div>
                <div class="flex flex-1 gap-3 rounded-lg border border-[#cedde8] bg-slate-50 p-4 flex-col">
                  <div class="text-[#0d151c]" data-icon="Person" data-size="24px" data-weight="regular">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
                      <path
                  ...
                  <div class="flex flex-col gap-1">
                    <h2 class="text-[#0d151c] text-base font-bold leading-tight">Week 2: Employee Relations</h2>
                    <p class="text-[#49779c] text-sm font-normal leading-normal">Learn how to manage employee relations and handle conflicts.</p>
                  </div>
                </div>
                <div class="flex flex-1 gap-3 rounded-lg border border-[#cedde8] bg-slate-50 p-4 flex-col">
                  ...
                  <div class="flex flex-col gap-1">
                    <h2 class="text-[#0d151c] text-base font-bold leading-tight">Week 3: Talent Management</h2>
                    <p class="text-[#49779c] text-sm font-normal leading-normal">Dive into the world of Talent Management and learn about different HR systems.</p>
                  </div>
                </div>
                <div class="flex flex-1 gap-3 rounded-lg border border-[#cedde8] bg-slate-50 p-4 flex-col">
                  <div class="text-[#0d151c]" data-icon="Checks" data-size="24px" data-weight="regular">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
                      <path
                  ...
                  <div class="flex flex-col gap-1">
                    <h2 class="text-[#0d151c] text-base font-bold leading-tight">Week 4: Compliance and Ethics</h2>
                    <p class="text-[#49779c] text-sm font-normal leading-normal">Master the art of Compliance and Ethics in the workplace.</p>
                  </div>
                </div>
              </div>
            </div>
