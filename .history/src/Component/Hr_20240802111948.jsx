        ...
        <div className=" w-full">
          ...
          <div className="flex flex-col gap-10 px-4 py-10 @container ">
            ...
            <div className="grid grid-cols-[repeat(auto-fit,minmax(158px,1fr))] gap-3 p-0 ">
              <div className="flex flex-1 gap-3 rounded-lg border border-[#cedde8] bg-slate-50 p-4 flex-col hover:shadow-lg hover:shadow-red-400">
                <div
              ...
              <div className="flex flex-1 gap-3 rounded-lg border border-[#cedde8] bg-slate-50 p-4 flex-col hover:shadow-lg hover:shadow-red-30000">
                <div
                  className="text-[#0d151c]"
                  data-icon="Checks"
                  data-size="24px"
