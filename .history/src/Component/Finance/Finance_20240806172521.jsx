        ...
        <div className=" w-full">
          ...
          <div className="flex flex-col gap-10 px-4 py-10 @container ">
            <div className="flex flex-col gap-4">
              ...
              This is a 5-week program. Each week we'll cover a different aspect of Finance. You'll <br/>learn by doing - we'll give you real-world projects to help you practice
