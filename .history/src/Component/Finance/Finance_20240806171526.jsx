      ...
      <div className="layout-container flex h-full grow flex-col">
        <header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-b-[#e7eef4] px-10 py-3">
          ...
          <div className="flex flex-1 justify-end gap-8">
            <div className="flex items-center gap-9">
              ...
              <a className="text-[#0d151c] text-sm font-medium leading-normal" href="#">Workshops</a>
              <a className="text-[#0d151c] text-sm font-medium leading-normal" href="#">Services</a>
              <a className="text-[#0d151c] text-sm font-medium leading-normal" href="#">Sign In</a>
            </div>
            <button
        ...
        <div className="px-40 flex flex-1 justify-center py-5">
          <div className="layout-content-container flex flex-col max-w-[960px] flex-1">
            ...
            <h1 className="text-[#0d151c] text-[22px] font-bold leading-tight tracking-[-0.015em] px-4 text-left pb-3 pt-5">Weekly Learning Objectives</h1>
            <div className="flex flex-col gap-10 px-4 py-10 @container">
              ...
              <div className="grid grid-cols-[repeat(auto-fit,minmax(158px,1fr))] gap-3 p-0">
                <div className="flex flex-1 gap-3 rounded-lg border border-[#cedde8] bg-slate-50 p-4 flex-col">
                  <div className="text-[#0d151c]" data-icon="Money" data-size="24px" data-weight="regular">
                  ...
                  <div className="flex flex-col gap-1">
                    <h2 className="text-[#0d151c] text-base font-bold leading-tight">Week 1: Introduction to Finance</h2>
                    <p className="text-[#49779c] text-sm font-normal leading-normal">Understand the basics of Finance and its applications in the industry.</p>
                  </div>
                </div>
                <div className="flex flex-1 gap-3 rounded-lg border border-[#cedde8] bg-slate-50 p-4 flex-col">
                  ...
                  <div className="flex flex-col gap-1">
                    <h2 className="text-[#0d151c] text-base font-bold leading-tight">Week 2: Financial Analysis</h2>
                    <p className="text-[#49779c] text-sm font-normal leading-normal">Learn how to analyze financial statements and make investment decisions.</p>
                  </div>
                </div>
                <div className="flex flex-1 gap-3 rounded-lg border border-[#cedde8] bg-slate-50 p-4 flex-col">
                  <div className="text-[#0d151c]" data-icon="Control" data-size="24px" data-weight="regular">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
                  ...
                  <div className="flex flex-col gap-1">
                    <h2 className="text-[#0d151c] text-base font-bold leading-tight">Week 3: Investment Management</h2>
                    <p className="text-[#49779c] text-sm font-normal leading-normal">Dive into the world of Investment Management and learn about different asset classes.</p>
                  </div>
                </div>
                <div className="flex flex-1 gap-3 rounded-lg border border-[#cedde8] bg-slate-50 p-4 flex-col">
                  <div className="text-[#0d151c]" data-icon="Warning" data-size="24px" data-weight="regular">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
                      <path
                  ...
                  <div className="flex flex-col gap-1">
                    <h2 className="text-[#0d151c] text-base font-bold leading-tight">Week 4: Risk Management</h2>
                    <p className="text-[#49779c] text-sm font-normal leading-normal">Master the art of Risk Management and its various techniques.</p>
                  </div>
                </div>
                <div className="flex flex-1 gap-3 rounded-lg border border-[#cedde8] bg-slate-50 p-4 flex-col">
                  <div className="text-[#0d151c]" data-icon="Perspective" data-size="24px" data-weight="regular">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
                      <path
                  ...
                  <div className="flex flex-col gap-1">
                    <h2 className="text-[#0d151c] text-base font-bold leading-tight">Week 5: Financial Modeling</h2>
                    <p className="text-[#49779c] text-sm font-normal leading-normal">Explore the realm of Financial Modeling and its applications in modern finance.</p>
                  </div>
                </div>
              </div>
            </div>
            <div className="flex flex-col gap-10 px-4 py-10 @container">
              ...
              <div className="grid grid-cols-[repeat(auto-fit,minmax(158px,1fr))] gap-3 p-0">
                ...
                <div className="flex flex-1 gap-3 rounded-lg border border-[#cedde8] bg-slate-50 p-4 flex-col">
                  ...
                  <div className="flex flex-col gap-1">
                    <h2 className="text-[#0d151c] text-base font-bold leading-tight">Learn from experienced Financial Analysts</h2>
                    <p className="text-[#49779c] text-sm font-normal leading-normal">Our instructors are experienced Financial Analysts from top companies</p>
                  </div>
                </div>
                <div className="flex flex-1 gap-3 rounded-lg border border-[#cedde8] bg-slate-50 p-4 flex-col">
                  ...
                  <div className="flex flex-col gap-1">
                    <h2 className="text-[#0d151c] text-base font-bold leading-tight">Master Financial Analysis skills</h2>
                ...
                <div className="flex flex-1 gap-3 rounded-lg border border-[#cedde8] bg-slate-50 p-4 flex-col">
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <p className="text-[#49779c] text-sm font-normal leading-normal">Get Job opportunities such as Financial Analyst, Investment Banker, Financial Planner, Risk Manager, Accountant, Financial Advisor, Tax Advisor, Credit Analyst, Budget Analyst.</p>
                  </div>
                </div>
              </div>
            </div>
            <h2 className="text-[#0d151c] text-[22px] font-bold leading-tight tracking-[-0.015em] px-4 pb-3 pt-5">Certificate Criteria</h2>
            ...
            <h2 className="text-[#0d151c] text-[22px] font-bold leading-tight tracking-[-0.015em] px-4 pb-3 pt-5">Cancellation Policy</h2>
            <p className="text-[#0d151c] text-base font-normal leading-normal pb-3 pt-1 px-4">
            ...
            <h1 className="text-[#0d151c] tracking-light text-[32px] font-bold leading-tight px-4 text-center pb-3 pt-6">Our Industry Partners</h1>
            ...
            <h1 className="text-[#0d151c] tracking-light text-[32px] font-bold leading-tight px-4 text-center pb-3 pt-6">What Our Students Say</h1>
            <div className="flex flex-col gap-8 overflow-x-hidden bg-slate-50 p-4">
              <div className="flex flex-col gap-3 bg-slate-50">
                <div className="flex-1">
                  <p className="text-[#0d151c] text-base font-medium leading-normal">Rachel Williams</p>
                  <p className="text-[#49779c] text-sm font-normal leading-normal">June 1, 2024</p>
                </div>
                <div className="flex gap-0.5">
                  <div className="text-[#2094f3]" data-icon="Star" data-size="20px" data-weight="fill">
              ...
              <div className="flex flex-col gap-3 bg-slate-50">
                <div className="flex-1">
                  <p className="text-[#0d151c] text-base font-medium leading-normal">John Smith</p>
                  <p className="text-[#49779c] text-sm font-normal leading-normal">May 15, 2024</p>
                </div>
                <div className="flex gap-0.5">
                  <div className="text-[#2094f3]" data-icon="Star" data-size="20px" data-weight="fill">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" fill="currentColor" viewBox="0 0 256 256">
              ...
              <div className="flex flex-col gap-3 bg-slate-50">
                <div className="flex-1">
                  <p className="text-[#0d151c] text-base font-medium leading-normal">Sarah Johnson</p>
                  <p className="text-[#49779c] text-sm font-normal leading-normal">April 30, 2024</p>
                </div>
                <div className="flex gap-0.5">
                  <div className="text-[#2094f3]" data-icon="Star" data-size="20px" data-weight="fill">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" fill="currentColor" viewBox="0 0 256 256">
            ...
            <div className="grid grid-cols-[repeat(auto-fit,minmax(158px,1fr))] gap-3 p-4">
              <div className="flex flex-col gap-3 pb-3">
                ...
                ></div>
                <div>
                  <p className="text-[#0d151c] text-base font-medium leading-normal">Financial Analysis Workshop</p>
                  <p className="text-[#49779c] text-sm font-normal leading-normal">August 15th, 2024</p>
                </div>
              </div>
              <div className="flex flex-col gap-3 pb-3">
                <div
                ...
                ></div>
                <div>
                  <p className="text-[#0d151c] text-base font-medium leading-normal">Investment Management Workshop</p>
                  <p className="text-[#49779c] text-sm font-normal leading-normal">August 22nd, 2024</p>
                </div>
              </div>
              <div className="flex flex-col gap-3 pb-3">
                <div
                ...
                ></div>
                <div>
                  <p className="text-[#0d151c] text-base font-medium leading-normal">Risk Management Workshop</p>
                  <p className="text-[#49779c] text-sm font-normal leading-normal">August 29th, 2024</p>
                </div>
              </div>
            </div>
          </div>
