      ...
      {/* <div>
        <div className="flex flex-col gap-10 px-4 py-10 @container">
          <div className="flex flex-col gap-4">
            ...
            <p className="text-[#0d151c] text-base font-normal leading-normal max-w-[720px]">
              Our Finance program is designed to help you grow as a Financial
              Analyst. Here are some of the benefits you'll get from completing
              the program.
            </p>
          </div>
          <div className="grid grid-cols-[repeat(auto-fit,minmax(158px,1fr))] gap-3 p-0">
            ...
            <div className="flex flex-1 gap-3 rounded-lg border border-[#cedde8] bg-slate-50 p-4 flex-col">
              ...
              <div className="flex flex-col gap-1">
                ...
                <p className="text-[#49779c] text-sm font-normal leading-normal">
                  Our instructors are experienced Financial Analysts from top
                  companies
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-1 gap-3 rounded-lg border border-[#cedde8] bg-slate-50 p-4 flex-col">
              ...
              <div className="flex flex-col gap-1">
                ...
                <p className="text-[#49779c] text-sm font-normal leading-normal">
                  Get Job opportunities such as Financial Analyst, Investment
                  Banker, Financial Planner, Risk Manager, Accountant, Financial
                  Advisor, Tax Advisor, Credit Analyst, Budget Analyst.
                </p>
              </div>
            </div>
          </div>
...
<div>
        <div className="flex flex-col gap-10 px-4 py-10 mt">
          <div className="flex flex-col gap-4">
            <h1 className="text-[#0d151c] tracking-light text-[32px] font-bold leading-tight @[480px]:text-4xl @[480px]:font-black @[480px]:leading-tight @[480px]:tracking-[-0.033em] max-w-[720px]">
              Benefits of the Program
            </h1>
