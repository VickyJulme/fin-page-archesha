      ...
      <div className="cont20    mt-28  ) ">
        ...
        <div className=" w-full">
          ...
          <div className="flex flex-col gap-10 px-4 py-10 @container ">
            ...
            <div C="grid grid-cols-[repeat(auto-fit,minmax(158px,1fr))] gap-3 p-0">
                <div C="flex flex-1 gap-3 rounded-lg border border-[#cedde8] bg-slate-50 p-4 flex-col">
                  <div C="text-[#0d151c]" data-icon="Money" data-size="24px" data-weight="regular">
                  ...
                  <div C="flex flex-col gap-1">
                    <h2 C="text-[#0d151c] text-base font-bold leading-tight">Week 1: Introduction to Finance</h2>
                    <p C="text-[#49779c] text-sm font-normal leading-normal">Understand the basics of Finance and its applications in the industry.</p>
                  </div>
                </div>
                <div C="flex flex-1 gap-3 rounded-lg border border-[#cedde8] bg-slate-50 p-4 flex-col">
                  <div C="text-[#0d151c]" data-icon="Presentation" data-size="24px" data-weight="regular">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
                      <path
                  ...
                  <div C="flex flex-col gap-1">
                    <h2 C="text-[#0d151c] text-base font-bold leading-tight">Week 2: Financial Analysis</h2>
                    <p C="text-[#49779c] text-sm font-normal leading-normal">Learn how to analyze financial statements and make investment decisions.</p>
                  </div>
                </div>
                <div C="flex flex-1 gap-3 rounded-lg border border-[#cedde8] bg-slate-50 p-4 flex-col">
                  <div C="text-[#0d151c]" data-icon="Control" data-size="24px" data-weight="regular">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
                  ...
                  <div C="flex flex-col gap-1">
                    <h2 C="text-[#0d151c] text-base font-bold leading-tight">Week 3: Investment Management</h2>
                    <p C="text-[#49779c] text-sm font-normal leading-normal">Dive into the world of Investment Management and learn about different asset classes.</p>
                  </div>
                </div>
                <div C="flex flex-1 gap-3 rounded-lg border border-[#cedde8] bg-slate-50 p-4 flex-col">
                  <div C="text-[#0d151c]" data-icon="Warning" data-size="24px" data-weight="regular">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
                      <path
                  ...
                  <div C="flex flex-col gap-1">
                    <h2 C="text-[#0d151c] text-base font-bold leading-tight">Week 4: Risk Management</h2>
                    <p C="text-[#49779c] text-sm font-normal leading-normal">Master the art of Risk Management and its various techniques.</p>
                  </div>
                </div>
                <div C="flex flex-1 gap-3 rounded-lg border border-[#cedde8] bg-slate-50 p-4 flex-col">
                  <div C="text-[#0d151c]" data-icon="Perspective" data-size="24px" data-weight="regular">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
                      <path
                  ...
                  <div C="flex flex-col gap-1">
                    <h2 C="text-[#0d151c] text-base font-bold leading-tight">Week 5: Financial Modeling</h2>
                    <p C="text-[#49779c] text-sm font-normal leading-normal">Explore the realm of Financial Modeling and its applications in modern finance.</p>
                  </div>
                </div>
              </div>
            </div>
