...
<div className="flex justify-center  flex-col items-center">
 ...
 <div Classn="flex flex-col gap-10 px-4 py-10 @container">
              <div Classn="flex flex-col gap-4">
                <h1
                  Classn="text-[#0d151c] tracking-light text-[32px] font-bold leading-tight @[480px]:text-4xl @[480px]:font-black @[480px]:leading-tight @[480px]:tracking-[-0.033em] max-w-[720px]"
                >
                  Benefits of the Program
                </h1>
                <p Classn="text-[#0d151c] text-base font-normal leading-normal max-w-[720px]">
              ...
              <div Classn="grid grid-cols-[repeat(auto-fit,minmax(158px,1fr))] gap-3 p-0">
                <div Classn="flex flex-1 gap-3 rounded-lg border border-[#cedde8] bg-slate-50 p-4 flex-col">
                  <div Classn="text-[#0d151c]" data-icon="Trophy" data-size="24px" data-weight="regular">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
                      <path
                  ...
                  <div Classn="flex flex-col gap-1">
                    <h2 Classn="text-[#0d151c] text-base font-bold leading-tight">Earn a certificate and badge</h2>
                    <p Classn="text-[#49779c] text-sm font-normal leading-normal">Get a certificate of completion and a digital badge to add to your portfolio</p>
                  </div>
                </div>
                <div Classn="flex flex-1 gap-3 rounded-lg border border-[#cedde8] bg-slate-50 p-4 flex-col">
                  <div Classn="text-[#0d151c]" data-icon="User" data-size="24px" data-weight="regular">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
                      <path
                  ...
                  <div Classn="flex flex-col gap-1">
                    <h2 Classn="text-[#0d151c] text-base font-bold leading-tight">Learn from experienced Financial Analysts</h2>
                    <p Classn="text-[#49779c] text-sm font-normal leading-normal">Our instructors are experienced Financial Analysts from top companies</p>
                  </div>
                </div>
                <div Classn="flex flex-1 gap-3 rounded-lg border border-[#cedde8] bg-slate-50 p-4 flex-col">
                  <div Classn="text-[#0d151c]" data-icon="Lightning" data-size="24px" data-weight="regular">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
                      <path
                  ...
                  <div Classn="flex flex-col gap-1">
                    <h2 Classn="text-[#0d151c] text-base font-bold leading-tight">Master Financial Analysis skills</h2>
                    <p Classn="text-[#49779c] text-sm font-normal leading-normal">Our curriculum is designed to help you master the skills needed in the industry</p>
                  </div>
                </div>
                <div Classn="flex flex-1 gap-3 rounded-lg border border-[#cedde8] bg-slate-50 p-4 flex-col">
                  <div Classn="text-[#0d151c]" data-icon="Briefcase" data-size="24px" data-weight="regular">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
                      <path
                  ...
                  <div Classn="flex flex-col gap-1">
                    <h2 Classn="text-[#0d151c] text-base font-bold leading-tight">Boost your career</h2>
                    <p Classn="text-[#49779c] text-sm font-normal leading-normal">Get Job opportunities such as Financial Analyst, Investment Banker, Financial Planner, Risk Manager, Accountant, Financial Advisor, Tax Advisor, Credit Analyst, Budget Analyst.</p>
                  </div>
                </div>
              </div>
            </div>
            <h2 Classn="text-[#0d151c] text-[22px] font-bold leading-tight tracking-[-0.015em] px-4 pb-3 pt-5">Certificate Criteria</h2>
            <p Classn="text-[#0d151c] text-base font-normal leading-normal pb-3 pt-1 px-4">
            ...
            <h2 Classn="text-[#0d151c] text-[22px] font-bold leading-tight tracking-[-0.015em] px-4 pb-3 pt-5">Cancellation Policy</h2>
            <p Classn="text-[#0d151c] text-base font-normal leading-normal pb-3 pt-1 px-4">
