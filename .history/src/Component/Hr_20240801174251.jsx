...
function Hr() {
  return (
    <div className='flex justify-center items-center'>
           ...
           <div className='con1  items-end flex  bg-red-500 mt-28  ) '>

                <div className='con2 w-full h-full items-end flex rounded-xl'>
                <div className="flex flex-col   gap-4  w-full mb-20 pl-20 ">
                    <h1
                    ...
                    <button
                    className="flex  cursor-pointer items-center justify-center overflow-hidden rounded-xl h-10 px-4 @[480px]:h-12 @[480px]:px-5 bg-[#2094f3] text-slate-50 text-sm font-bold leading-normal tracking-[0.015em] @[480px]:text-base @[480px]:font-bold @[480px]:leading-normal @[480px]:tracking-[0.015em]"
                  >
