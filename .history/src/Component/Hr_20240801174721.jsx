    ...
    <div className='flex justify-center items-center'>
           ...
           <div className='con1  items-end flex  bg-red-500 mt-28  ) '>
                ...
                <div className="flex flex-col   gap-4  w-full mb-20 pl-20 ">
                    ...
                    <button
                    className="  w-20 py-3   cursor-pointer items-center justify-center overflow-hidden rounded-xl px-4  bg-[#2094f3] text-slate-50 text-sm font-bold leading-normal ]"
                  >
